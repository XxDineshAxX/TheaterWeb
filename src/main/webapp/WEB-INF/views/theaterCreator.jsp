...
<form action="create.html" method= "Post">
		 ...
		 <div class="form-group">
		      <label for= ""tName"">TheaterName:</label>
		   <input type= "text" class= "form-control " name= "tName">
		   </div>
		 <div class= "form-group">
		  <label for= "numOfScreens">Number Of Screens:</label>
		    <input type= "text" class= "form-control " name= "numOfScreens">
		  </div>
		  <div class= "form-group">
		  ...
		  <label for= "numOfRows">Number Of Rows:</label>
		    <input type= "text" class= "form-control " name= "numOfRows">
		  </div>
		  <div class= "form-group">
		  <label for= "numOfSeatsPerRow">Number Of Seats Per Row:</label>
		    <input type= "text" class= "form-control " name= "numOfSeatsPerRow">
		  </div>
			<input type= "submit" value= "Create Theater">
